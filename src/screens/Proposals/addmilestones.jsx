...
const addmilestones = ({ project: projectProp, route: routeProp }) => {
  ...
  const averageProgress = Math.round(milestones.reduce((acc, m) => acc + m.progress, 0) / milestones.length) || 0;

  return (
    <View style={styles.container}>
      {/* Added Header Component */}
      <Header title="Project Milestones" showBackButton={true} />
      
      <ScrollView showsVerticalScrollIndicator={false}>
        {/* Removed old header section and replaced with custom header buttons */}
...
const styles = StyleSheet.create({
  ...
  // Removed headerTitle style since Header component handles it
  headerSubtitle: {
