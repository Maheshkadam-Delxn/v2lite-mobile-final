...
//         console.log('[EditProfile] 👤 User ID:', id);
...
//         console.log('[EditProfile] 🌐 Status:', res.status);
//         const json = await res.json();

//         if (!res.ok) {
//           console.log('[EditProfile] ❌ Error:', json);
//           return;
//         }

//         const data = json.data;
//         console.log('[EditProfile] ✅ User data:', data);
...
//   const openCamera = async () => {
//     const hasPermission = await requestCameraPermission();
//     if (!hasPermission) return Alert.alert('Permission required', 'Camera permission is required.');
...
//   const openGallery = async () => {
//     const hasPermission = await requestGalleryPermission();
//     if (!hasPermission) return Alert.alert('Permission required', 'Gallery permission is required.');
...
//   const handleSignatureUploadPress = () => setShowSignatureOptions(true);
...
//       console.log('[EditProfile] 🌐 PUT Status:', res.status);
//       const json = await res.json();
...
//       } else {
//         console.log('[EditProfile] ✅ Update Success:', json);
...
//             <Image
//               source={{
//                 uri: signature || 'https://ui-avatars.com/api/?name=' + encodeURIComponent(fullName || 'User'),
//               }}
...
//               onPress={handleSignatureUploadPress}
//             >
//               <Feather name="edit-2" size={16} color="#FFFFFF" />
//             </TouchableOpacity>
//           </View>
...
//       <View className="absolute bottom-0 left-0 right-0 bg-white pt-4 pb-8 px-5 border-t border-[#E5E5E5]">
//         <TouchableOpacity className="bg-[#0066FF] py-4 rounded-lg items-center" onPress={handleSave}>
//           <Text className="text-base text-white" style={{ fontFamily: 'Urbanist-Bold' }}>
