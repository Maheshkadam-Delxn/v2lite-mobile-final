...
// import { View, Text, TextInput, TouchableOpacity, ScrollView, SafeAreaView, Modal, ActivityIndicator } from 'react-native';
...
//             // Map based on API structure from logs (e.g., _id, name, category, updatedAt)
//             const mappedProposals = data.map((item) => ({
//               id: item._id, // Use _id as ID
//               name: item.name || 'Unnamed Template',
//               category: item.category || 'General',
//               categoryColor: getCategoryColor(item.category || 'General'), // Map color
//               lastModified: new Date(item.updatedAt).toLocaleString('en-GB', {
//                 day: '2-digit',
//                 month: '2-digit',
//                 year: 'numeric',
//                 hour: '2-digit',
...
//   // Helper to map category to color (based on static example; adjust for API)
//   const getCategoryColor = (category) => {
//     const colorMap = {
//       'Residential': '#00D4FF', // Example for "Luxury Villa"
//       'Office': '#0066FF',
//       'Home': '#00D4FF',
//       'Business': '#0066FF',
//       // Add more as per API
