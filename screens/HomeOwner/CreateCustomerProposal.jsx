...
const CreateCustomerProposalScreen = ({ navigation }) => {
  const [title, setTitle] = useState('Project Name 1');
  const [clientName, setClientName] = useState('Arun Mishra');
  const [address, setAddress] = useState('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna...');
  ...
  const [notes, setNotes] = useState('The budget includes material costs, labor, and subcontractor fees.Client approvals are required at key project milestones.Additional customization may impact the final budget.');
...
export default CreateCustomerProposalScreen;